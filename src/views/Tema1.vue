...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap
      .col-xl-8.pe-xl-4.d-flex.flex-wrap.align-items-center.order-2.order-xl-1
        .cajon.color-acento-contenido.p-4.d-flex.flex-wrap(data-aos="fade-right")
          .col-md-11.ps-lg-4
            p Esta es una actividad multidisciplinaria que a través de la promoción y prevención busca mejorar el bienestar de los trabajadores al igual que pretende evitar los accidentes en el ambiente laboral. 
              br
              br
              | Para lograr esto, se propone que se tengan en cuenta las condiciones de trabajo, así como la organización del mismo, con el fin de reducir sustancialmente los factores de riesgo que puedan derivar en enfermedades o accidentes de tipo laboral. 
    ...
    .row.mb-5
      ...
      .p-4.d-flex.flex-wrap.col-12.col-md-7(data-aos="fade-left")
        .col-sm.mb-5.mb-sm-0
          ol.lista-ol--cuadro
            li 
    ...
    .d-flex.flex-wrap.mb-5
      .col-xl-8.pe-xl-4.d-flex.flex-wrap.align-items-center.order-2.order-xl-1(data-aos="fade-right")
        p Los riesgos laborales se definen como "las eventualidades dañosas a que está sujeto el trabajador, con ocasión o por consecuencia de su actividad" (Rojas Cárdenas y Salomón Aguilar, 2016). En el subsector avícola, se identifican varios riesgos principales, como la manipulación de sustancias químicas, los cambios de temperatura dentro de los galpones, la exposición constante al ruido, a polvos y vapores, así como las posturas prolongadas fuera de los ángulos de confort.
        p En Colombia, se cuenta con el Decreto 1295 de 1994, la Resolución ICA y la Resolución 3651 de 2014 del Instituto Colombiano Agropecuario. A través de estas disposiciones se establecen los requisitos para la certificación de granjas avícolas bioseguras de postura y/o levante, además de dictar otras regulaciones. Los niveles de riesgo se clasifican en una escala del 1 al 5, siendo el sector avícola clasificado como nivel 2. No obstante, una empresa tiene la posibilidad de cotizar para diferentes niveles de riesgo, dependiendo de los distintos centros de trabajo que haya establecido. Por ejemplo, una compañía puede tener un centro de trabajo administrativo que cotice en el nivel de riesgo 1 y otro centro de trabajo productivo que cotice en el nivel de riesgo 4 (Rojas Cárdenas y Salomón Aguilar, 2016).
        p El trabajo en granjas o unidades avícolas conlleva diversos tipos de riesgos, tales como biológicos, químicos, higiénicos, psicológicos, ergonómicos, físicos, mecánicos, físicos no mecánicos, eléctricos, locativos y riesgos explosivos y de incendio.
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h4 Prevención de riesgos laborales en granjas avícolas 
                  p.text-small Para ampliar la información sobre los principales riesgos laborales puede consultar el siguiente documento “Prevención de Riesgos Laborales en Granjas Avícolas”.
                .col-sm-auto
                  a.boton.color-acento-botones(href="https://libraria.xunta.gal/sites/default/files/downloads/publicacion/2015_200-15_15-00655_-_prevencion_de_riesgos_laborales_en_granjas_avicolas._os_atende_do_issga._folleto.pdf" target="_blank")
                    span Descargar
